...
.st-key-sl_language_top .stButtonGroup [data-baseweb="button-group"] { width: auto; min-width: 78px; gap: 2px; padding: 3px; background: #ffffff; border: 1px solid #d6e2e8; border-radius: 10px; box-shadow: 0 5px 14px rgba(0, 0, 0, .18); }
.st-key-sl_language_top .stButtonGroup button { min-width: 34px; min-height: 30px; padding: 2px 7px; color: #17324d !important; background: #f3f7f8; border: 1px solid transparent; border-radius: 7px; font-size: 11px; font-weight: 800; line-height: 1; }
.st-key-sl_language_top .stButtonGroup button * { color: #17324d !important; }
.st-key-sl_language_top .stButtonGroup button:hover { color: #0c6471 !important; background: #dff3f4; }
.st-key-sl_language_top .stButtonGroup button:hover * { color: #0c6471 !important; }
.st-key-sl_language_top .stButtonGroup button[aria-checked="true"] { color: #ffffff !important; background: #087e8b; border-color: #087e8b; box-shadow: 0 2px 5px rgba(8,126,139,.28); }
.st-key-sl_language_top .stButtonGroup button[aria-checked="true"] * { color: #ffffff !important; }
.st-key-sl_language_top .stButtonGroup button:focus-visible { outline: 3px solid #7be2e7; outline-offset: 2px; }
