...
def build_submission_html(report: Dict, meta: Dict,
    ...
    if biased_rows:
        ...
        geometry_bias_html = (
            ...
            f"Lead converged by 1.5&nbsp;m, and steel and concrete by 2.5&ndash;3.5&nbsp;m, "
            f"except concrete at &mu;x&nbsp;4, which still rose 0.7% over its last metre. Its "
            f"true factor may be larger, so that step is added to the upper limit. Energies other "
            f"than 364 and 511&nbsp;keV were not measured, so these results may still read "
            f"<b>low</b>, the non-conservative direction. The out-of-domain guard "
    ...
    finite_field_scope_html = (
        ...
        "1.72&times; in concrete at &mu;x&nbsp;4, the shallowest depth measured, and below that "
