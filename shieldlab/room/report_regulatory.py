...
def build_submission_html(report: Dict, meta: Dict,
    ...
    finite_field_scope_html = (
        ...
        "concrete at 140.5, 364, 511 and 1077&nbsp;keV and interpolated between them; below "
        "140.5&nbsp;keV the 140.5&nbsp;keV factor is held, unmeasured, and other materials take "
        "the concrete factor, the largest measured. The deficit was already "
